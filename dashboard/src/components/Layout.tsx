      ...
      <div className={clsx(
        ...
        <div className="relative flex w-full max-w-xs flex-col bg-white pt-5 pb-4 shadow-xl">
          ...
          <div className="flex flex-shrink-0 items-center px-4">
            <h1 className="text-2xl font-bold text-gray-900">AgentVault</h1>
          </div>
            ...
            <div className="flex flex-1">
              <div className="flex w-full md:ml-0">
                <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                  ...
                  <input
                    className="block h-full w-full border-0 bg-transparent py-2 pl-10 pr-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm"
